  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 bg-blue-gray-50">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-center text-4xl text-black mb-8">Got Questions? We&apos;ve Got Answers</h1>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="p-8">
              ...
              >
                ...
                <span
                  className="text-white bg-[#c1dbe5] h-8 w-8 rounded-full text-center active:bg-[#204F61] cursor-pointer"
                >
                  {open === index ? "−" : "+"}
                </span>
              </button>
        ...
        <div className="mt-6 text-center">
          <button className="bg-[#F14D5D] text-white px-6 py-4 rounded-md shadow-md hover:bg-white hover:text-black focus:outline-none">
